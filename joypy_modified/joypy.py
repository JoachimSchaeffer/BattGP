# This file is based on: https://github.com/leotac/joypy/
# joypy is not maintained anymore and a couple of modificaiton were needed to get
# this running.
...
def _joyplot(
    ...
    **kwargs,
    ...
    print(f" Global x range: {global_x_min} to {global_x_max}")
    ...
    if ylim == "max":
        ...
        try:
            ...
            print(
                f"{e} occured. Warning: the value of ylim must be either 'max', 'own', or a tuple of length 2. The value you provided has no effect."
            )
