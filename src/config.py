...
# Set up labels for classification, training / validation split
PATH_FIELDDATA_CONFIG = "data/data_setup.csv"
...
PATH_GP_MODELING = "results/gp_modeling/"
...
# MEan hyperparameters associated with: batt_gp_run_20240315093810
# Noise Variance         4.761712e-07
# RBF Lengthscale 1      2.622616e+01
# RBF Lengthscale 2      4.514599e+01
# RBF Lengthscale 3      4.333714e+01
# RBF Outputscale        2.101502e+01
# Training Time          1.796696e+01
# Wiener Outputscale     1.205708e-10 # We set it lower here, the
# # Median hyperparameters:
# Parameter
# Marginal Likelihood   -7.212475e+04
# Noise Variance         4.455805e-07
# RBF Lengthscale 1      2.620620e+01
# RBF Lengthscale 2      4.476204e+01
# RBF Lengthscale 3      4.054266e+01
# RBF Outputscale        2.379992e+01
# Training Time          1.782399e+01
# Wiener Outputscale     1.040978e-11
# Intruiging cell:
# 1	2.9462571541304466e-07
# 2	1.1199121728113323e-12
# 3	5.464775803640607
# 4	19.820746382233413
# 5	51.67817631750437
# 6	42.36786022332649

# Mode: 6, 8, 10: batt_gp_run_20240328114334
# NOISE_VARIANCE = (2.52e-7,)
# OUTPUTSCALE_WIENER = 6.07e-14
# OUTPUTSCALE_RBF = 0.024
# LENGTHSCALE_RBF = (20.00, 42.86, 46.61)

# mode, 6, 8, 10, 12: batt_gp_run_20240328114334
# NOISE_VARIANCE = (2.18e-7,)
# OUTPUTSCALE_WIENER = 9.7e-14
# OUTPUTSCALE_RBF = 0.015
# LENGTHSCALE_RBF = (18.53, 41.81, 49.15)
# Run 6, 8: Mode:
# NOISE_VARIANCE = (6.58e-7,)
# OUTPUTSCALE_WIENER = 1.15e-13
# OUTPUTSCALE_RBF = 0.00025
# LENGTHSCALE_RBF = (9.24, 13.93, 17.47)
# Run: 6, 8: Mean:
# NOISE_VARIANCE = (2.67e-6,)
# OUTPUTSCALE_WIENER = 6.29e-13
# OUTPUTSCALE_RBF = 0.127
# LENGTHSCALE_RBF = (12.43, 38.35, 48.26)
